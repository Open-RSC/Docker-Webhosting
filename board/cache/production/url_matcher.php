...
class phpbb_url_matcher extends Symfony\Component\Routing\Matcher\UrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // flerex_linkedaccounts_switch
        if (0 === strpos($pathinfo, '/switchaccount') && preg_match('#^/switchaccount/(?P<account_id>\\d+)$#sD', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'flerex_linkedaccounts_switch')), array (  '_controller' => 'flerex.linkedaccounts.switcher:handle',));
        }
