...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000003d6d6eb00000000458bf228(
...
class phpbbtemplatetwiglexer_0000000003d6d6eb00000000458bf228 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b9aa697e25f9316352922 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b9aa697e2612743791961 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b9aa697e25b1683641781 = array(
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, 'set_environment', array('env' => $env), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;

        return $this->valueHolder5b9aa697e25f9316352922->set_environment($env);
    }
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;

        return $this->valueHolder5b9aa697e25f9316352922->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;

        return $this->valueHolder5b9aa697e25f9316352922->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b9aa697e2612743791961 = $initializer;
    }
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, '__get', array('name' => $name), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;

        if (isset(self::$publicProperties5b9aa697e25b1683641781[$name])) {
            return $this->valueHolder5b9aa697e25f9316352922->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b9aa697e25f9316352922;
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, '__isset', array('name' => $name), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, '__unset', array('name' => $name), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;
    ...
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, '__clone', array(), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;

        $this->valueHolder5b9aa697e25f9316352922 = clone $this->valueHolder5b9aa697e25f9316352922;
    }

    public function __sleep()
    {
        $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, '__sleep', array(), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;

        return array('valueHolder5b9aa697e25f9316352922');
    }
    ...
    {
        return $this->initializer5b9aa697e2612743791961;
    }
    ...
    {
        return $this->initializer5b9aa697e2612743791961 && ($this->initializer5b9aa697e2612743791961->__invoke($valueHolder5b9aa697e25f9316352922, $this, 'initializeProxy', array(), $this->initializer5b9aa697e2612743791961) || 1) && $this->valueHolder5b9aa697e25f9316352922 = $valueHolder5b9aa697e25f9316352922;
    }
    ...
    {
        return null !== $this->valueHolder5b9aa697e25f9316352922;
    }
    ...
    {
        return $this->valueHolder5b9aa697e25f9316352922;
    }
