...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001a4d5eb400000000272d824e(
...
class phpbbtemplatetwiglexer_000000001a4d5eb400000000272d824e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b9aa8228d7ad511718978 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b9aa8228d7c2750460493 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b9aa8228d771295834100 = array(
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, 'set_environment', array('env' => $env), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;

        return $this->valueHolder5b9aa8228d7ad511718978->set_environment($env);
    }
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;

        return $this->valueHolder5b9aa8228d7ad511718978->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;

        return $this->valueHolder5b9aa8228d7ad511718978->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 = $initializer;
    }
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, '__get', array('name' => $name), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;

        if (isset(self::$publicProperties5b9aa8228d771295834100[$name])) {
            return $this->valueHolder5b9aa8228d7ad511718978->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b9aa8228d7ad511718978;
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, '__isset', array('name' => $name), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, '__unset', array('name' => $name), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;
    ...
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, '__clone', array(), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;

        $this->valueHolder5b9aa8228d7ad511718978 = clone $this->valueHolder5b9aa8228d7ad511718978;
    }

    public function __sleep()
    {
        $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, '__sleep', array(), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;

        return array('valueHolder5b9aa8228d7ad511718978');
    }
    ...
    {
        return $this->initializer5b9aa8228d7c2750460493;
    }
    ...
    {
        return $this->initializer5b9aa8228d7c2750460493 && ($this->initializer5b9aa8228d7c2750460493->__invoke($valueHolder5b9aa8228d7ad511718978, $this, 'initializeProxy', array(), $this->initializer5b9aa8228d7c2750460493) || 1) && $this->valueHolder5b9aa8228d7ad511718978 = $valueHolder5b9aa8228d7ad511718978;
    }
    ...
    {
        return null !== $this->valueHolder5b9aa8228d7ad511718978;
    }
    ...
    {
        return $this->valueHolder5b9aa8228d7ad511718978;
    }
