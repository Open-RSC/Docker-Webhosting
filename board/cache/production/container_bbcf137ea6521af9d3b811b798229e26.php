...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006d728444000000004ee1874c(
...
class phpbbtemplatetwiglexer_000000006d728444000000004ee1874c extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5b9ab366b589d697037525 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b9ab366b58bc633722997 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b9ab366b5855259784299 = array(
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, 'set_environment', array('env' => $env), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;

        return $this->valueHolder5b9ab366b589d697037525->set_environment($env);
    }
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;

        return $this->valueHolder5b9ab366b589d697037525->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;

        return $this->valueHolder5b9ab366b589d697037525->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5b9ab366b58bc633722997 = $initializer;
    }
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, '__get', array('name' => $name), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;

        if (isset(self::$publicProperties5b9ab366b5855259784299[$name])) {
            return $this->valueHolder5b9ab366b589d697037525->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5b9ab366b589d697037525;
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, '__isset', array('name' => $name), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, '__unset', array('name' => $name), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;
    ...
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, '__clone', array(), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;

        $this->valueHolder5b9ab366b589d697037525 = clone $this->valueHolder5b9ab366b589d697037525;
    }

    public function __sleep()
    {
        $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, '__sleep', array(), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;

        return array('valueHolder5b9ab366b589d697037525');
    }
    ...
    {
        return $this->initializer5b9ab366b58bc633722997;
    }
    ...
    {
        return $this->initializer5b9ab366b58bc633722997 && ($this->initializer5b9ab366b58bc633722997->__invoke($valueHolder5b9ab366b589d697037525, $this, 'initializeProxy', array(), $this->initializer5b9ab366b58bc633722997) || 1) && $this->valueHolder5b9ab366b589d697037525 = $valueHolder5b9ab366b589d697037525;
    }
    ...
    {
        return null !== $this->valueHolder5b9ab366b589d697037525;
    }
    ...
    {
        return $this->valueHolder5b9ab366b589d697037525;
    }
