...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006e3d75d90000000048eefc6a(
...
class phpbbtemplatetwiglexer_000000006e3d75d90000000048eefc6a extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ba1b82ae4e2e074756946 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ba1b82ae4ea0408329287 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ba1b82ae4d4a399507423 = array(
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, 'set_environment', array('env' => $env), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;

        return $this->valueHolder5ba1b82ae4e2e074756946->set_environment($env);
    }
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;

        return $this->valueHolder5ba1b82ae4e2e074756946->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;

        return $this->valueHolder5ba1b82ae4e2e074756946->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 = $initializer;
    }
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, '__get', array('name' => $name), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;

        if (isset(self::$publicProperties5ba1b82ae4d4a399507423[$name])) {
            return $this->valueHolder5ba1b82ae4e2e074756946->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ba1b82ae4e2e074756946;
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, '__isset', array('name' => $name), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, '__unset', array('name' => $name), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;
    ...
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, '__clone', array(), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;

        $this->valueHolder5ba1b82ae4e2e074756946 = clone $this->valueHolder5ba1b82ae4e2e074756946;
    }

    public function __sleep()
    {
        $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, '__sleep', array(), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;

        return array('valueHolder5ba1b82ae4e2e074756946');
    }
    ...
    {
        return $this->initializer5ba1b82ae4ea0408329287;
    }
    ...
    {
        return $this->initializer5ba1b82ae4ea0408329287 && ($this->initializer5ba1b82ae4ea0408329287->__invoke($valueHolder5ba1b82ae4e2e074756946, $this, 'initializeProxy', array(), $this->initializer5ba1b82ae4ea0408329287) || 1) && $this->valueHolder5ba1b82ae4e2e074756946 = $valueHolder5ba1b82ae4e2e074756946;
    }
    ...
    {
        return null !== $this->valueHolder5ba1b82ae4e2e074756946;
    }
    ...
    {
        return $this->valueHolder5ba1b82ae4e2e074756946;
    }
