...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'flerex.linkedaccounts.listener' => 'getFlerex_Linkedaccounts_ListenerService',
            'flerex.linkedaccounts.switcher' => 'getFlerex_Linkedaccounts_SwitcherService',
            'flerex.linkedaccounts.utils' => 'getFlerex_Linkedaccounts_UtilsService',
            ...
            'rmcgirr83.activity24hours.listener' => 'getRmcgirr83_Activity24hours_ListenerService',
            ...
            'senky.userrecentactivity.listener' => 'getSenky_Userrecentactivity_ListenerService',
    ...
    protected function getAttachment_DeleteService()
    {
        ...
        return new \phpbb\attachment\delete($this->get('config'), $a, $this->get('dispatcher'), $this->get('filesystem'), new \phpbb\attachment\resync($a), './board/');
    }
    ...
    protected function getAttachment_ManagerService()
    {
        ...
        return new \phpbb\attachment\manager(new \phpbb\attachment\delete($b, $a, $c, $this->get('filesystem'), new \phpbb\attachment\resync($a), './board/'), new \phpbb\attachment\resync($a), new \phpbb\attachment\upload($this->get('auth'), $this->get('cache'), $b, $this->get('files.upload'), $this->get('language'), $this->get('mimetype.guesser'), $c, $this->get('plupload'), $this->get('user'), './board/'));
    }
    ...
    protected function getAttachment_UploadService()
    {
        ...
        return new \phpbb\attachment\upload($this->get('auth'), $this->get('cache'), $this->get('config'), new \phpbb\files\upload($this->get('filesystem'), $this->get('files.factory'), $a, $this->get('php_ini'), $this->get('request')), $a, $this->get('mimetype.guesser'), $this->get('dispatcher'), $this->get('plupload'), $this->get('user'), './board/');
    }
    ...
    {
        return $this->services['auth.provider.apache'] = new \phpbb\auth\provider\apache($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), './board/', 'php');
    }
    ...
    {
        return $this->services['auth.provider.db'] = new \phpbb\auth\provider\db($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), $this, './board/', 'php');
    }
    ...
    {
        $this->services['avatar.driver.gravatar'] = $instance = new \phpbb\avatar\driver\gravatar($this->get('config'), $this->get('upload_imagesize'), './board/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.local'] = $instance = new \phpbb\avatar\driver\local($this->get('config'), $this->get('upload_imagesize'), './board/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.remote'] = $instance = new \phpbb\avatar\driver\remote($this->get('config'), $this->get('upload_imagesize'), './board/', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), './board/', 'php', $this->get('filesystem'), $this->get('path_helper'), $this->get('dispatcher'), $this->get('files.factory'), $this->get('cache.driver'));
    ...
    {
        return $this->services['cache'] = new \phpbb\cache\service($this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), './board/', 'php');
    }
    ...
    {
        $this->services['class_loader'] = $instance = new \phpbb\class_loader('phpbb\\', './board/includes/', 'php');
    ...
    {
        $this->services['class_loader.ext'] = $instance = new \phpbb\class_loader('\\', './board/ext/', 'php');
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate($this->get('user'), $this->get('language'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), $this->get('filesystem'), './board/');
    }
    ...
    {
        return $this->services['console.command.db.revert'] = new \phpbb\console\command\db\revert($this->get('user'), $this->get('language'), $this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), $this->get('filesystem'), './board/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.delete'] = new \phpbb\console\command\thumbnail\delete($this->get('user'), $this->get('dbal.conn'), './board/');
    }
    ...
    {
        return $this->services['console.command.thumbnail.generate'] = new \phpbb\console\command\thumbnail\generate($this->get('user'), $this->get('dbal.conn'), $this->get('cache'), './board/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.activate'] = new \phpbb\console\command\user\activate($this->get('user'), $this->get('dbal.conn'), $this->get('config'), $this->get('language'), $this->get('log'), $this->get('notification_manager'), $this->get('user_loader'), './board/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.add'] = new \phpbb\console\command\user\add($this->get('user'), $this->get('dbal.conn'), $this->get('config'), $this->get('language'), $this->get('passwords.manager'), './board/', 'php');
    }
    ...
    {
        return $this->services['console.command.user.delete'] = new \phpbb\console\command\user\delete($this->get('user'), $this->get('dbal.conn'), $this->get('language'), $this->get('log'), $this->get('user_loader'), './board/', 'php');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './board/', 'php', 'phpbb_forums', 'phpbb_posts', 'phpbb_topics', 'phpbb_users');
    }
    ...
    {
        return $this->services['controller.resolver'] = new \phpbb\controller\resolver($this, './board/', $this->get('template'));
    }
    ...
    {
        return $this->services['cron.manager'] = new \phpbb\cron\manager($this->get('cron.task_collection'), './board/', 'php');
    }
    ...
    {
        $this->services['cron.task.core.prune_all_forums'] = $instance = new \phpbb\cron\task\core\prune_all_forums('./board/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_forum'] = $instance = new \phpbb\cron\task\core\prune_forum('./board/', 'php', $this->get('config'), $this->get('dbal.conn'));
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('./board/', 'php', $this->get('config'), $this->get('dbal.conn'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.queue'] = $instance = new \phpbb\cron\task\core\queue('./board/', 'php', $this->get('config'), './board/cache/production/');
    ...
    {
        $this->services['cron.task.core.tidy_database'] = $instance = new \phpbb\cron\task\core\tidy_database('./board/', 'php', $this->get('config'));
    ...
    {
        $this->services['cron.task.core.tidy_plupload'] = $instance = new \phpbb\cron\task\core\tidy_plupload('./board/', $this->get('config'), $this->get('log'), $this->get('user'));
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('./board/', 'php', $this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('dispatcher'));
    ...
    {
        $this->services['cron.task.core.tidy_warnings'] = $instance = new \phpbb\cron\task\core\tidy_warnings('./board/', 'php', $this->get('config'));
    ...
    {
        return new \phpbb\db\extractor\mssql_extractor('./board/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\mysql_extractor('./board/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\oracle_extractor('./board/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\postgres_extractor('./board/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    {
        return new \phpbb\db\extractor\sqlite3_extractor('./board/', $this->get('request'), $this->get('dbal.conn.driver'));
    }
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('flerex.linkedaccounts.listener', 'flerex\\linkedaccounts\\event\\main_listener');
        $instance->addSubscriberService('phpbb.mediaembed.listener', 'phpbb\\mediaembed\\event\\main_listener');
        $instance->addSubscriberService('phpbbmodders.banhammer.listener', 'phpbbmodders\\banhammer\\event\\banhammer_listener');
        $instance->addSubscriberService('rmcgirr83.activity24hours.listener', 'rmcgirr83\\activity24hours\\event\\listener');
        $instance->addSubscriberService('senky.userrecentactivity.listener', 'senky\\userrecentactivity\\event\\listener');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbb_ext', './board/', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['feed.quote_helper'] = new \phpbb\feed\quote_helper($this->get('user'), './board/', 'php');
    }
    ...
    {
        return $this->services['file_locator'] = new \phpbb\routing\file_locator($this->get('filesystem'), './board/');
    }
    ...
    {
        return new \phpbb\files\filespec($this->get('filesystem'), $this->get('language'), $this->get('php_ini'), $this->get('upload_imagesize'), './board/', $this->get('mimetype.guesser'), $this->get('plupload'));
    }
    ...
    {
        return new \phpbb\files\types\remote($this->get('config'), $this->get('files.factory'), $this->get('language'), $this->get('php_ini'), $this->get('request'), './board/');
    }
    ...
    /**
     * Gets the public 'flerex.linkedaccounts.listener' shared service.
     *
     * @return \flerex\linkedaccounts\event\main_listener
     */
    protected function getFlerex_Linkedaccounts_ListenerService()
    {
        return $this->services['flerex.linkedaccounts.listener'] = new \flerex\linkedaccounts\event\main_listener($this->get('auth'), $this->get('template'), $this->get('controller.helper'), $this->get('flerex.linkedaccounts.utils'));
    }

    /**
     * Gets the public 'flerex.linkedaccounts.switcher' shared service.
     *
     * @return \flerex\linkedaccounts\controller\switcher
     */
    protected function getFlerex_Linkedaccounts_SwitcherService()
    {
        return $this->services['flerex.linkedaccounts.switcher'] = new \flerex\linkedaccounts\controller\switcher($this->get('user'), $this->get('auth'), $this->get('request'), $this->get('flerex.linkedaccounts.utils'));
    }

    /**
     * Gets the public 'flerex.linkedaccounts.utils' shared service.
     *
     * @return \flerex\linkedaccounts\service\utils
     */
    protected function getFlerex_Linkedaccounts_UtilsService()
    {
        return $this->services['flerex.linkedaccounts.utils'] = new \flerex\linkedaccounts\service\utils($this->get('user'), $this->get('dbal.conn'), 'phpbb_flerex_linkedaccounts');
    }
    ...
    {
        return $this->services['hook_finder'] = new \phpbb\hook\finder('./board/', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['language.helper.language_file'] = new \phpbb\language\language_file_helper('./board/');
    }
    ...
    {
        $this->services['language.loader'] = $instance = new \phpbb\language\language_file_loader('./board/', 'php');
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './board/', 'adm/', 'php', 'phpbb_log');
    }
    ...
    {
        return $this->services['message.form.admin'] = new \phpbb\message\admin_form($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('dbal.conn'), $this->get('user'), './board/', 'php');
    }
    ...
    {
        return $this->services['message.form.topic'] = new \phpbb\message\topic_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), './board/', 'php');
    }
    ...
    {
        return $this->services['message.form.user'] = new \phpbb\message\user_form($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), './board/', 'php');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'phpbb_migrations', './board/', 'php', 'phpbb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './board/', 'php', 'phpbb_modules');
    }
    ...
    {
        return $this->services['migrator.tool.permission'] = new \phpbb\db\migration\tool\permission($this->get('dbal.conn'), $this->get('cache'), $this->get('auth'), './board/', 'php');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'phpbb_modules', './board/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\email($this->get('user_loader'), $this->get('user'), $this->get('config'), './board/', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\jabber($this->get('user_loader'), $this->get('user'), $this->get('config'), './board/', 'php');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './board/', 'php', 'phpbb_user_notifications');
    ...
    {
        return $this->services['passwords.driver.md5_phpbb2'] = new \phpbb\passwords\driver\md5_phpbb2($this->get('request'), $this->get('passwords.driver.salted_md5'), $this->get('passwords.driver_helper'), './board/', 'php');
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), $this->get('request'), './board/', 'php', 'adm/');
    }
    ...
    {
        return $this->services['phpbb.help.controller.bbcode'] = new \phpbb\help\controller\bbcode($this->get('controller.helper'), $this->get('phpbb.help.manager'), $this->get('template'), $this->get('language'), './board/', 'php');
    }
    ...
    {
        return $this->services['phpbb.help.controller.faq'] = new \phpbb\help\controller\faq($this->get('controller.helper'), $this->get('phpbb.help.manager'), $this->get('template'), $this->get('language'), './board/', 'php');
    }
    ...
    /**
     * Gets the public 'phpbb.mediaembed.listener' shared service.
     *
     * @return \phpbb\mediaembed\event\main_listener
     */
    protected function getPhpbb_Mediaembed_ListenerService()
    {
        return $this->services['phpbb.mediaembed.listener'] = new \phpbb\mediaembed\event\main_listener($this->get('auth'), $this->get('config'), $this->get('config_text'), $this->get('language'), $this->get('template'));
    }
    ...
    {
        return $this->services['phpbb.report.controller'] = new \phpbb\report\controller\report($this->get('config'), $this->get('user'), $this->get('template'), $this->get('controller.helper'), $this->get('request'), $this->get('captcha.factory'), $this->get('phpbb.report.handler_factory'), $this->get('phpbb.report.report_reason_list_provider'), './board/', 'php');
    }
    ...
    {
        return $this->services['phpbbmodders.banhammer.listener'] = new \phpbbmodders\banhammer\event\banhammer_listener($this->get('auth'), $this->get('cache.driver'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('phpbbmodders.banhammer.core.bantime'), './board/', 'php');
    }
    ...
    {
        return $this->services['plupload'] = new \phpbb\plupload\plupload('./board/', $this->get('config'), $this->get('request'), $this->get('user'), $this->get('php_ini'), $this->get('mimetype.guesser'));
    }
    ...
    {
        return $this->services['request'] = new \phpbb\request\request(NULL, false);
    }
    ...
    /**
     * Gets the public 'rmcgirr83.activity24hours.listener' shared service.
     *
     * @return \rmcgirr83\activity24hours\event\listener
     */
    protected function getRmcgirr83_Activity24hours_ListenerService()
    {
        return $this->services['rmcgirr83.activity24hours.listener'] = new \rmcgirr83\activity24hours\event\listener($this->get('auth'), $this->get('cache'), $this->get('config'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('template'), $this->get('user'), NULL);
    }
    ...
    {
        return $this->services['router'] = new \phpbb\routing\router($this, $this->get('routing.chained_resources_locator'), $this->get('routing.delegated_loader'), 'php', './board/cache/production/');
    }
    ...
    {
        return $this->services['routing.helper'] = new \phpbb\routing\helper($this->get('config'), $this->get('router'), $this->get('symfony_request'), $this->get('request'), $this->get('filesystem'), './board/', 'php');
    }
    ...
    {
        return $this->services['routing.resources_locator.default'] = new \phpbb\routing\resources_locator\default_resources_locator('./board/', 'production', $this->get('ext.manager'));
    }

    /**
     * Gets the public 'senky.userrecentactivity.listener' shared service.
     *
     * @return \senky\userrecentactivity\event\listener
     */
    protected function getSenky_Userrecentactivity_ListenerService()
    {
        return $this->services['senky.userrecentactivity.listener'] = new \senky\userrecentactivity\event\listener($this->get('dbal.conn'), $this->get('config'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('content.visibility'), './board/', 'php');
    }
    ...
    {
        return $this->services['template'] = new \phpbb\template\twig\twig($this->get('path_helper'), $this->get('config'), $this->get('template_context'), $this->get('template.twig.environment'), './board/cache/production/twig/', $this->get('user'), $this->get('template.twig.extensions.collection'), $this->get('ext.manager'));
    }
    ...
    {
        $this->services['template.twig.environment'] = $instance = new \phpbb\template\twig\environment($this->get('config'), $this->get('filesystem'), $this->get('path_helper'), './board/cache/production/twig/', $this->get('ext.manager'), $this->get('template.twig.loader'), $this->get('dispatcher'), array());
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000064d887f70000000030488f36(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'phpbb_bbcodes', 'phpbb_smilies', 'phpbb_styles', 'phpbb_words', './board/styles/');
    }
    ...
    {
        return $this->services['text_formatter.s9e.factory'] = new \phpbb\textformatter\s9e\factory($this->get('text_formatter.data_access'), $this->get('cache.driver'), $this->get('dispatcher'), $this->get('config'), $this->get('text_formatter.s9e.link_helper'), $this->get('log'), './board/cache/production/', '_text_formatter_parser', '_text_formatter_renderer');
    }
    ...
    {
        return $this->services['text_formatter.s9e.quote_helper'] = new \phpbb\textformatter\s9e\quote_helper($this->get('user'), './board/', 'php');
    }
    ...
    protected function getTextFormatter_S9e_RendererService()
    {
        ...
        $this->services['text_formatter.s9e.renderer'] = $instance = new \phpbb\textformatter\s9e\renderer($this->get('cache.driver'), './board/cache/production/', '_text_formatter_renderer', $this->get('text_formatter.s9e.factory'), $this->get('dispatcher'));
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './board/', 'php', 'phpbb_users');
    }
    ...
    {
        return array(
            'core.root_path' => './board/',
            'core.php_ext' => 'php',
            'core.environment' => 'production',
            'core.debug' => false,
            'core.cache_dir' => './board/cache/production/',
            'passwords.driver.bcrypt_cost' => 10,
            'text_formatter.cache.dir' => './board/cache/production/',
            'text_formatter.cache.parser.key' => '_text_formatter_parser',
            'text_formatter.cache.renderer.key' => '_text_formatter_renderer',
            'core.template.cache_path' => './board/cache/production/twig/',
            ...
            'flerex.linkedaccounts.tables.links' => 'phpbb_flerex_linkedaccounts',
...
class phpbbtemplatetwiglexer_0000000064d887f70000000030488f36 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ba1a0e321ca7684544692 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ba1a0e321d17176236759 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ba1a0e321bc9836194879 = array(
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, 'set_environment', array('env' => $env), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;

        return $this->valueHolder5ba1a0e321ca7684544692->set_environment($env);
    }
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;

        return $this->valueHolder5ba1a0e321ca7684544692->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;

        return $this->valueHolder5ba1a0e321ca7684544692->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ba1a0e321d17176236759 = $initializer;
    }
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, '__get', array('name' => $name), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;

        if (isset(self::$publicProperties5ba1a0e321bc9836194879[$name])) {
            return $this->valueHolder5ba1a0e321ca7684544692->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ba1a0e321ca7684544692;
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, '__isset', array('name' => $name), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, '__unset', array('name' => $name), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;
    ...
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, '__clone', array(), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;

        $this->valueHolder5ba1a0e321ca7684544692 = clone $this->valueHolder5ba1a0e321ca7684544692;
    }

    public function __sleep()
    {
        $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, '__sleep', array(), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;

        return array('valueHolder5ba1a0e321ca7684544692');
    }
    ...
    {
        return $this->initializer5ba1a0e321d17176236759;
    }
    ...
    {
        return $this->initializer5ba1a0e321d17176236759 && ($this->initializer5ba1a0e321d17176236759->__invoke($valueHolder5ba1a0e321ca7684544692, $this, 'initializeProxy', array(), $this->initializer5ba1a0e321d17176236759) || 1) && $this->valueHolder5ba1a0e321ca7684544692 = $valueHolder5ba1a0e321ca7684544692;
    }
    ...
    {
        return null !== $this->valueHolder5ba1a0e321ca7684544692;
    }
    ...
    {
        return $this->valueHolder5ba1a0e321ca7684544692;
    }
