...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['senky.userrecentactivity.listener'] = new \senky\userrecentactivity\event\listener($this->get('dbal.conn'), $this->get('config'), $this->get('auth'), $this->get('template'), $this->get('user'), $this->get('content.visibility'), './', 'php');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007fa80680000000005f7a3eef(
...
class phpbbtemplatetwiglexer_000000007fa80680000000005f7a3eef extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ba1a1a5d9176671010815 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ba1a1a5d9202775312016 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ba1a1a5d9089857710977 = array(
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, 'set_environment', array('env' => $env), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;

        return $this->valueHolder5ba1a1a5d9176671010815->set_environment($env);
    }
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;

        return $this->valueHolder5ba1a1a5d9176671010815->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;

        return $this->valueHolder5ba1a1a5d9176671010815->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 = $initializer;
    }
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, '__get', array('name' => $name), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;

        if (isset(self::$publicProperties5ba1a1a5d9089857710977[$name])) {
            return $this->valueHolder5ba1a1a5d9176671010815->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ba1a1a5d9176671010815;
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, '__isset', array('name' => $name), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, '__unset', array('name' => $name), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;
    ...
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, '__clone', array(), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;

        $this->valueHolder5ba1a1a5d9176671010815 = clone $this->valueHolder5ba1a1a5d9176671010815;
    }

    public function __sleep()
    {
        $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, '__sleep', array(), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;

        return array('valueHolder5ba1a1a5d9176671010815');
    }
    ...
    {
        return $this->initializer5ba1a1a5d9202775312016;
    }
    ...
    {
        return $this->initializer5ba1a1a5d9202775312016 && ($this->initializer5ba1a1a5d9202775312016->__invoke($valueHolder5ba1a1a5d9176671010815, $this, 'initializeProxy', array(), $this->initializer5ba1a1a5d9202775312016) || 1) && $this->valueHolder5ba1a1a5d9176671010815 = $valueHolder5ba1a1a5d9176671010815;
    }
    ...
    {
        return null !== $this->valueHolder5ba1a1a5d9176671010815;
    }
    ...
    {
        return $this->valueHolder5ba1a1a5d9176671010815;
    }
