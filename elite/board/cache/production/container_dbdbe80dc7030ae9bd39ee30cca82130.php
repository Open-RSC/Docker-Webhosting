...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004577b8790000000066793aaa(
...
class phpbbtemplatetwiglexer_000000004577b8790000000066793aaa extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ba1a0eaf3378080317010 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ba1a0eaf33e3547385098 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ba1a0eaf3292916162418 = array(
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, 'set_environment', array('env' => $env), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;

        return $this->valueHolder5ba1a0eaf3378080317010->set_environment($env);
    }
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;

        return $this->valueHolder5ba1a0eaf3378080317010->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;

        return $this->valueHolder5ba1a0eaf3378080317010->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 = $initializer;
    }
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, '__get', array('name' => $name), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;

        if (isset(self::$publicProperties5ba1a0eaf3292916162418[$name])) {
            return $this->valueHolder5ba1a0eaf3378080317010->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ba1a0eaf3378080317010;
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, '__isset', array('name' => $name), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, '__unset', array('name' => $name), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;
    ...
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, '__clone', array(), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;

        $this->valueHolder5ba1a0eaf3378080317010 = clone $this->valueHolder5ba1a0eaf3378080317010;
    }

    public function __sleep()
    {
        $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, '__sleep', array(), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;

        return array('valueHolder5ba1a0eaf3378080317010');
    }
    ...
    {
        return $this->initializer5ba1a0eaf33e3547385098;
    }
    ...
    {
        return $this->initializer5ba1a0eaf33e3547385098 && ($this->initializer5ba1a0eaf33e3547385098->__invoke($valueHolder5ba1a0eaf3378080317010, $this, 'initializeProxy', array(), $this->initializer5ba1a0eaf33e3547385098) || 1) && $this->valueHolder5ba1a0eaf3378080317010 = $valueHolder5ba1a0eaf3378080317010;
    }
    ...
    {
        return null !== $this->valueHolder5ba1a0eaf3378080317010;
    }
    ...
    {
        return $this->valueHolder5ba1a0eaf3378080317010;
    }
