	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<a class="nav-link js-scroll-trigger" href="#chat">Chat Log</a>
				</li>
				<li class="nav-item">
...
<section id="home" class="about-section text-center">
	<div class="container">
		<div class="row">
			<div class="col-lg-3 text-white ml-2">
				What is Lorem Ipsum?
			...
			<div class="col-md mx-auto">
				...
				<div class="text-white">Daring To Imagine An Entirely New Direction</div>-->
				<!-- Game Links Section-->
				...
				<br><br>
				<a href="game.openrsc.com/downloads/openrsc.apk"><img class="android" src="img/android.png" class="img-fluid" height="300px" width="600px;"></a>
			</div>
			<div class="col-lg-3 text-white mr-2">
				<?php activityfeed() ?>
			</div>
		</div>
	</div>
	<!-- Footer -->
	<div class="bg-black fixed-bottom social d-flex justify-content-center">
		<a href="#" class="mx-2">
