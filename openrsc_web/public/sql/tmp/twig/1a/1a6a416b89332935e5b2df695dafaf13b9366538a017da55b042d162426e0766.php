...
';
    ...
    {
        return new Twig_Source('', 'server/databases/databases_footer.twig', '/var/www/html/sql/templates/server/databases/databases_footer.twig');
    }
}
