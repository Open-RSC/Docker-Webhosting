...
';
    ...
    {
        return new Twig_Source('', 'table/structure/actions_in_table_structure.twig', '/var/www/html/sql/templates/table/structure/actions_in_table_structure.twig');
    }
}
