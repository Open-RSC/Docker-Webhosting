...
class Table
{
    ...
    {
        return new self($table_name, $db_name, $dbi);
    }
     ...
     */
    public static function generateFieldSpec($name, $type, $length = '',
    ...
    public static function moveCopy($source_db, $source_table, $target_db,
        ...
        if ($move && $what == 'data') {
            $tbl = new self($source_table, $source_db);
        ...
        if ($what != 'dataonly') {
            ...
            if (isset($_POST['drop_if_exists'])
                ...
                $tbl = new self($target_db, $target_table);
        ...
        $_table = new self($target_table, $target_db);
        ...
        if (($what == 'data' || $what == 'dataonly')
            ...
            $_old_table = new self($source_table, $source_db);
        ...
        if ($move) {
            ...
            $_source_table = new self($source_table, $source_db);
    ...
    public function rename($new_name, $new_db = null)
    {
        ...
        $new_table = new self($new_name, $new_db);
