		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-lg-5 text-primary table-black">
					...
					No donations or subscriptions are accepted. We don't want any money. We also don't believe that dumping player money into ads will make any difference for long term player growth and retention. The best way to help the team is to help with submitting bug reports, fixing bugs, and spreading the word to your friends about us so they will want to come be a part of this too!

					<span class="text-info font-weight-bold d-block pt-4">How often is Open RSC updated?</span>
					Updates are added multiple times per week. Most are installed during the midnight automatic server restart interval.

					<span class="text-info font-weight-bold d-block pt-4">Is this a replica? What is the experience rate?</span>
					Open RSC is an open source game engine framework that lets you configure the features you want for any sort of play style want. Included in the source code are several preset server configurations that we are using for publicly hosted game servers that are free for anyone to play on.
					...
					<span class="text-info font-weight-bold d-block pt-4">How do I run my own Open RSC private server?</span>
					...
					Join the Discord chat and come talk to us! Word of mouth recommendations, YouTube videos, and Twitch streams are welcomed for recruiting more players. There are many GitLab issue bug reports that need fixes too!

					<span class="text-info font-weight-bold d-block pt-4">How do I run my own copy?</span>
					Visit the <a href="https://orsc.dev">Open RSC game repository</a> and follow the instructions. Open RSC is Windows, Mac, and Linux compatible! There is an Android client as well, though no way to run a MySQL server, the game server, and game client at the same time on Android too allow an Android single player instance at this time. Feel free to join our Discord if you have questions.

					<span class="text-info font-weight-bold d-block pt-4">Any future plans for development?</span>
					Achieving near-exact replication of RSC is important but there are so many new things that can be be added. Many projects are being worked on at the same time and if you have a novel idea and the ability to build it, go for it! Just understand that we have no interest in hearing pitches for the next million billion dollar game idea. Also, Eevee is the best Pokemon and cabbage is the best vegetable.
				</div>
			</div>
		</div>
	</div>
