	...
	<div class="panel position-fixed table-wrapper-scroll-y">
		<div class="text-info table-dark spaced-body full-width">
			<div class="container border-left border-info border-right table-wrapper-scroll-y mCustomScrollbar"
				...
				<div class="sm-skill col-4 d-inline-block text-center pt-3 display-glow">
					<img style="transform: scale(1.3);" src="/img/items/{{ $itemdef->id }}.png"/>
				...
				<input type="text" class="pl-2 mb-3" id="inputBox" onkeyup="search()" placeholder="Search for a NPC"/>
