...
class HighscoresController extends Controller
{
	...
	public function show($subpage)
	{
		...
		/**
		 * @var $experienceArray
		 * Experience to level calculation array
		 */
		 ...
		 * Experience to level calculation array
		 */
		$statNames = array('exp_attack', 'exp_defense', 'exp_strength', 'exp_hits', 'exp_ranged', 'exp_prayer', 'exp_magic', 'exp_cooking', 'exp_woodcut', 'exp_fletching', 'exp_fishing', 'exp_firemaking', 'exp_crafting', 'exp_smithing', 'exp_mining', 'exp_herblaw', 'exp_agility', 'exp_thieving', 'exp_runecraft');
