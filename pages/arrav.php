...
<div class="text-info table-dark" style="height: 100vh; width: 100vw;">
	<div class="border-left border-info border-right table-wrapper-scroll-y container">
		<h2 class="h2 text-center text-capitalize display-3" style="font-size: 38px;">Shield of Arrav</h2>
					...
					<div class="pl-3 pr-3 container">
						...
						<div class="flex-row stats">
							<div id="sm-stats col">
								...
								<span class="text-info">Difficulty:</span> <span class="h6 text-info font-weight-bold">***</span><span
									class="h6">**</span><br>
						...
						<div class="stats pl-5 pr-5" id="accordion">
							...
							<div id="collapsephoenix" class="collapse hide" aria-labelledby="headingOne"
								...
								entrance.
								<br><br>
								Go to the Blue Moon Inn and then fight and kill Jonny the Beard. He will drop a scroll,
								an
						...
						<div class="stats pl-5 pr-5" id="accordion">
							...
							<div id="collapseblackarm" class="collapse hide" aria-labelledby="headingOne"
								 data-parent="#accordion">
								After reading the book, talk to the Tramp near Varrock's southern gate. Ask him what is
								down
								...
								enter the building.
								<br><br>
								Talk to Katrine about the Black Arm Gang, and ask to join. She will want you to steal
								two
								...
								up the ladder.
								<br><br>
								The two crossbows are in this room, but if you steal them, the Weaponsmaster (level 25)
								will
								...
								<br><br>
								Now go upstairs and search the cupboard to find the right half of the Broken Shield.
								Note
