...
$connector = new Dbc();
$logins48 = $connector->cabbagegamequery("SELECT id, combat, username, group_id, login_date FROM openrsc_players WHERE login_date >= unix_timestamp( current_date - interval 48 hour) AND banned = '0' ORDER BY login_date DESC LIMIT 1000");
