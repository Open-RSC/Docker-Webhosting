					...
					<div class="pl-3 pr-3 container">
						<div class="pb-1" align="center">
							<img class="display-glow img-fluid"
								 src="../img/quests/Black_Knight_Quest_Complete.png">
						</div>
						...
						<div class="flex-row stats pl-5 pr-5">
							<div class="sm-stats col-sm">
								...
								<span class="d-block d-responsive"><span class="text-info">Items needed:</span>
									<li>- Medium Bronze Helmet (Can be bought from Peksa's Helmet Shop in Barbarian Village)</li>
									<li>- Iron Chain Mail Body (Can be bought from Horvik's Armour Shop in Varrock, or from Wayne's Chains in Falador)</li>
									<li>- Cabbage (One that is not from the patch near Draynor Manor)</li>
								</span>
								<span class="d-block"><span
										class="text-info">Requirements:</span> 12 Quest Points</span>
						...
						<div class="stats pl-5 pr-5" id="accordion">
							...
							<div id="collapsewalkthrough" class="pt-3 collapse hide" aria-labelledby="headingOne"
								...
								<img class="pb-2 img-fluid" src="../img/quests/Sir_Amik_Varze.png">
								<span class="d-block">
						...
						<div class="stats pl-5 pr-5" id="accordion">
							...
							<div id="collapsephoenix" class="pt-3 collapse hide" aria-labelledby="headingOne"
								 data-parent="#accordion">
								<img class="pb-2 img-fluid" src="../img/quests/Cabbage_patch.png">
						...
						<div class="stats pl-5 pr-5" id="accordion">
							...
							<div id="collapseblackarm" class="pt-3 collapse hide" aria-labelledby="headingOne"
								...
								<img class="pt-2 pb-2 img-fluid" src="../img/quests/Black_Knight_Odd_looking_wall.png">
								...
								<img class="pt-2 pb-2 img-fluid" src="../img/quests/Black_Knights_Fortress_1.png">
							</div>
						</div>
						...
						<div class="stats pl-5 pr-5" id="accordion">
							...
							<div id="collapsefinale" class="pt-3 collapse hide" aria-labelledby="headingOne"
								...
								<img class="pt-2 pb-2 img-fluid" src="../img/quests/Black_Knight_hole.png">
								...
								<img class="pt-2 pb-2 img-fluid" src="../img/quests/Black_Knight_Quest_Complete.png">
							</div>
						</div>
